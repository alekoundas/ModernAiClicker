    ...
    public partial class FrameDetailUserControlVM : ObservableObject, INotifyPropertyChanged
    {
        ...
        public FrameDetailUserControlVM(IBaseDatawork baseDatawork, IServiceProvider serviceProvider)
        {
            ...
            _flowStepPageFactory = new Dictionary<FlowStepTypesEnum, Lazy<IFlowStepDetailPage>>
            {
                ...
                { FlowStepTypesEnum.MOUSE_MOVE_COORDINATES, new Lazy<IFlowStepDetailPage>(() => serviceProvider.GetRequiredService<CursorRelocateFlowStepPage>()) },
            ...
            _executionFlowStepPageFactory = new Dictionary<FlowStepTypesEnum, Lazy<IExecutionPage>>
            {
                ...
                { FlowStepTypesEnum.MOUSE_MOVE_COORDINATES, new Lazy<IExecutionPage>(() => serviceProvider.GetRequiredService<CursorRelocateExecutionPage>()) },
