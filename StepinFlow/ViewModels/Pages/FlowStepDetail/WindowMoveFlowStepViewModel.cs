...
{
    public partial class WindowMoveFlowStepViewModel : BaseFlowStepDetailVM
    {
        ...
        public WindowMoveFlowStepViewModel(FlowsViewModel flowsViewModel, ISystemService systemService, IBaseDatawork baseDatawork) : base(baseDatawork)
        {
