...
namespace Business.Migrations
{
    ...
    [Migration("20250101191215_MigrationmuultipleLoopTemplate")]
    partial class MigrationmuultipleLoopTemplate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Model.Models.Execution", b =>
                {
                    ...
                    b.Property<int?>("CurrentMultipleTemplateSearchFlowStepId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("CurrentMultipleTemplateSearchFlowStepId");
            ...
            modelBuilder.Entity("Model.Models.Execution", b =>
                {
                    ...
                    b.HasOne("Model.Models.FlowStep", "CurrentMultipleTemplateSearchFlowStep")
                        .WithMany("CurrentMultipleTemplateSearchFlowStepExecutions")
                        .HasForeignKey("CurrentMultipleTemplateSearchFlowStepId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("CurrentMultipleTemplateSearchFlowStep");
            ...
            modelBuilder.Entity("Model.Models.FlowStep", b =>
                {
                    ...
                    b.Navigation("CurrentMultipleTemplateSearchFlowStepExecutions");
